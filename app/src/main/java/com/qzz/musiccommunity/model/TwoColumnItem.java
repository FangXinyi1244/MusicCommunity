...
import static com.qzz.musiccommunity.model.iface.ListItem.TYPE_TWO_COLUMN;
...
public class TwoColumnItem implements ListItem {
    private int moduleId;
    private String title;
    private List<MusicInfo> musicList;

    public TwoColumnItem(ModuleConfig moduleConfig) {
